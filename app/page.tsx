        ...
        <div className="max-w-4xl mx-auto mb-12 space-y-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 rounded-xl bg-gray-800/50 border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <svg
