    ...
    <div className="group relative bg-[#131313] rounded overflow-hidden border border-[#1a1a1a] hover:border-[#8B5CF6] transition-all duration-300 hover:shadow-lg hover:shadow-[#8B5CF6]/20">
      ...
      <div className="relative w-full h-80 overflow-hidden bg-black">
        ...
        <div className="absolute top-3 left-3">
          <div className={`px-2 py-1 rounded text-xs font-bold backdrop-blur-sm ${
        ...
        <button
          ...
          className="absolute top-3 left-3 bg-black/70 backdrop-blur-sm text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#8B5CF6] hover:text-white"
          style={{ left: '3.5rem' }}
        >
      ...
      <div className="p-4">
        ...
        <div className="mb-2">
          <span className="inline-block bg-[#1a1a1a] text-[#8B5CF6] text-xs px-2 py-1 rounded border border-[#8B5CF6]/30">
            {series.genre}
          </span>
        </div>
